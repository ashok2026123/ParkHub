...
export default function App() {
  ...
  if (!user) {
    return <LoginScreen onLogin={(emailOrPhone, password) => loginWithCredentials(emailOrPhone, password)} onGuestLogin={loginAsGuest} roleHint="Customer" />;
  }
...
function LoginScreen({ onLogin, onGuestLogin, roleHint }) {
